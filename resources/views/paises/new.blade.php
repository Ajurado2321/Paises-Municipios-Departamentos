    ...
    <form method="POST" action="{{route('paises.store')}}">
     @csrf
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="idCountry" aria-describedby="idHelp" name="idCountry">
          <div id="idHelp" class="form-text">Maximo 3 caracteres</div>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" required class="form-control" id="name"  aria-describedby="nameHelp"
            name="nameCountry" placeholder="Comuna name">
        </div>

    <label for="municipality">municipality</label>
    <select class="form-select" id="countryNationality" name="countryNationality" required>
