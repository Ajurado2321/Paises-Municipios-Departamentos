...
<div class="card-body">
        <form method="POST" action="{{route('paises.update', ['pais'=>$pais->pais_codi])}}">
          ...
          @csrf
            <div class="mb-3">
              <label for="codigo" class="form-label">Country Code</label>
              <input type="text" class="form-control" id="idCountry" aria-describedby="codigoHelp" name="idCountry" 
            ...
            <div class="mb-3">
              ...
              <input type="text" required class="form-control" id="nameCountry" placeholder="Commune name"
                name="nameCountry" value="{{$pais->pais_nomb}}">
            </div>
